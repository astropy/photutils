...
New fourier_cutoff parameter
-----------------------------

The :func:`~photutils.psf_matching.create_matching_kernel` function now
includes a ``fourier_cutoff`` parameter to regularize division by
...
instabilities when the source PSF has very small Fourier coefficients::
    ...
    >>> kernel = create_matching_kernel(source_psf, target_psf,
    ...                                 fourier_cutoff=1e-4)
...
Both :func:`~photutils.psf_matching.create_matching_kernel` and
