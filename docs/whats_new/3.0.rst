...
Passing **optional** arguments positionally to functions in the
`~photutils.centroids` and `~photutils.detection` packages is now
deprecated. In the future, all optional arguments must be passed as
