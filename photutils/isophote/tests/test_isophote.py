...
class TestIsophote:
    ...
    def test_fit(self):
        ...
        assert iso.a3 is None or abs(iso.b3) <= 0.01
        assert iso.a3 is None or abs(iso.a4) <= 0.01
        assert iso.a3 is None or abs(iso.b4) <= 0.01
    ...
    def test_m51(self):
        ...
        assert iso.a3 is None or abs(iso.b3) <= 0.05
        assert iso.a3 is None or abs(iso.a4) <= 0.05
        assert iso.a3 is None or abs(iso.b4) <= 0.05
