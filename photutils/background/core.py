...
class BackgroundBase(metaclass=abc.ABCMeta):
    ...
    def _prepare_data(self, data, axis):
        return _prepare_data(self.sigma_clip, data, axis)

    def _apply_masked(self, result, masked):
